...
public class Poll extends TableImpl<PollRecord> {
     ...
     */
    public final TableField<PollRecord, Integer> A_POLL_ID = createField("a_poll_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("nextval('poll_a_poll_id_seq'::regclass)", org.jooq.impl.SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>public.poll.poll_id</code>.
     */
    public final TableField<PollRecord, String> POLL_ID = createField("poll_id", org.jooq.impl.SQLDataType.VARCHAR(200).nullable(false), this, "");

    /**
     * The column <code>public.poll.poll_title</code>.
     */
    public final TableField<PollRecord, String> POLL_TITLE = createField("poll_title", org.jooq.impl.SQLDataType.VARCHAR(500), this, "");

    /**
     * The column <code>public.poll.poll_question</code>.
     */
    public final TableField<PollRecord, String> POLL_QUESTION = createField("poll_question", org.jooq.impl.SQLDataType.VARCHAR(2000), this, "");

    /**
     * The column <code>public.poll.created_by</code>.
     */
    public final TableField<PollRecord, Integer> CREATED_BY = createField("created_by", org.jooq.impl.SQLDataType.INTEGER, this, "");
